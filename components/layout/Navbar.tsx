      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-5">
            ...
            {/* Cart */}
            <span className="text-white/60 text-[10px] tracking-[0.15em] uppercase" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Carrito
            </span>     
            <Link
              href="/cart"
      ...
      >
        <div className="bg-black/98 border-t border-white/5 px-6 pt-4 pb-8">
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <Link href="/cart" aria-label="Cart" className="relative text-white/50 hover:text-white transition-colors" onClick={() => setMenuOpen(false)}>         
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18M16 10a4 4 0 01-8 0" />
              </svg>
              <span className="absolute -top-1.5 -right-1.5 bg-[#c9a96e] text-black text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center">{mounted ? totalItems : 0}</span>
            </Link>
            <Link
              href="/login"
