...
export default function CasasPerfumistas() {
  ...
  return (
    <section
      ...
      className="bg-[#080808] py-24 md:py-32 border-y border-[#c9a96e]/15"
    >
      <div className="max-w-7xl mx-auto px-6 text-center mb-16">
        ...
        <h2
          ...
          style={{ fontFamily: serif }}
        >
          Las firmas más <span className="italic text-[#c9a96e]">codiciadas</span>
        </h2>
        <p
      ...
      <div className="relative overflow-hidden" aria-hidden="true">
        ...
        >
          {loop.map((name, i) => (
            <span
              key={`${name}-${i}`}
              className="text-white/40 grayscale text-2xl md:text-3xl tracking-wider hover:text-[#c9a96e] transition-colors duration-500"
            >
              {name}
            </span>
          ))}
